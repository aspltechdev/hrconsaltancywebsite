        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6 sm:mb-8 text-center lg:text-left">
              ...
              talent acquisition, and organizational development. Our specialized <span className="font-bold text-foreground">Payroll Services</span> ensure seamless statutory compliance and operational efficiency.
            </p>
